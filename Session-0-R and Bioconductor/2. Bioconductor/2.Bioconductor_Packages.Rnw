...
<<instalador, echo=FALSE, print=FALSE, results=HIDE>>=
...
%--------------------------------------------------------------------------------------------------------------------------------
\section{Infrastructure packages}
\subsection{\textbf{IRanges}}
...
%--------------------------------------------------------------------------------------------------------------------------------
\subsection{GenomicFeatures}
\begin{frame}
\frametitle{GenomicFeatures}
\begin{column}{1\textwidth}
  \bit
      \item management of transcript information
        \bit
